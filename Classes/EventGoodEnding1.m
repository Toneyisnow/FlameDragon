...
-(void) initialBattle
{
	...
	[self settleFriend:13 At:CGPointMake(20,10)];
    [self settleFriend:14 At:CGPointMake(21,10)];
	[self settleFriend:15 At:CGPointMake(15,11)];
	[self settleFriend:16 At:CGPointMake(16,11)];
	[self settleFriend:17 At:CGPointMake(17,11)];
	[self settleFriend:18 At:CGPointMake(18,11)];
	[self settleFriend:19 At:CGPointMake(19,11)];
	[self settleFriend:20 At:CGPointMake(20,11)];
	[self settleFriend:21 At:CGPointMake(21,11)];
	[self settleFriend:22 At:CGPointMake(15,12)];
	[self settleFriend:23 At:CGPointMake(16,12)];
	[self settleFriend:24 At:CGPointMake(17,12)];
	[self settleFriend:25 At:CGPointMake(18,12)];
	[self settleFriend:26 At:CGPointMake(19,12)];
	[self settleFriend:27 At:CGPointMake(20,12)];
	[self settleFriend:28 At:CGPointMake(21,12)];
	[self settleFriend:29 At:CGPointMake(16,13)];
	[self settleFriend:30 At:CGPointMake(17,13)];
	[self settleFriend:31 At:CGPointMake(18,13)];
	[self settleFriend:32 At:CGPointMake(19,13)];
	
    [self settleFriend:1 At:CGPointMake(18,16)];
